...
from memory.memory_manager import GraphMemory
...
class GraphWithMemory:
    ...
    def __init__(self):
        ...
        self.tools = [self.memory.save_recall_memory, self.memory.search_recall_memories]
    ...
    def load_memories(state: MemoryState, config: RunnableConfig) -> MemoryState:
        ...
        recall_memories = GraphWithMemory.memory.search_recall_memories.invoke(convo_str, config)
        return {
